...
This repo contains work-in-progress documentation for .NET. To contribute, see the [Contributing Guide](https://docs.microsoft.com/fr-fr/contribute/) and the [issues list](https://github.com/dotnet/docs/issues). 
